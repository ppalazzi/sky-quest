...
export const ModalProfile = ({openModal}: ProfileProps) => {
	return (
		<div className={openModal ? 'absolute w-52 top-14 right-8 rounded-md border shadow-lg bg-white z-[999]' : 'hidden'}>
			<ul className="p-4 space-y-2 w-full">
				...
				<li className="flex justify-start items-center border-2 border-transparent hover:border-2
				 hover:bg-sidebar-accent	rounded-md transition-colors w-full  text-sm gap-2 cursor-pointer">
					<Settings size={14}/>
