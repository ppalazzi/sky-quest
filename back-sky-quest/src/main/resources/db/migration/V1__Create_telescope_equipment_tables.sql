...
(
    ...
    focal_ratio  VARCHAR(20)  NOT NULL,
...
INSERT INTO skyquest.telescope (brand, model, type, aperture, focal_length, focal_ratio, mount_type, weight, price)
VALUES
...
('Sky-Watcher', 'Flextube 300P SynScan', 'DOBSONIAN', '305mm (12 in)', '1500mm', 'f/4.9', 'GoTo Dobsonian', '28 kg',
 '$1,899'),
...
INSERT INTO skyquest.camera (brand, model, sensor_type, resolution, pixel_size, cooling_type, interface_type, weight,
                             price, description)
VALUES ('ZWO', 'ASI533MC Pro', 'CMOS', '3008x3008', '3.76μm', 'TEC Cooled', 'USB 3.0', '665g', '$899',
        'Color astronomy camera with Sony IMX533 sensor'),
       ('ZWO', 'ASI294MM Pro', 'CMOS', '4144x2822', '4.63μm', 'TEC Cooled', 'USB 3.0', '720g', '$1,199',
        'Monochrome astronomy camera with Sony IMX294 sensor'),
       ('QHY', 'QHY268M', 'CMOS', '6280x4210', '3.76μm', 'TEC Cooled', 'USB 3.0', '1200g', '$2,299',
        'Monochrome camera with Sony IMX571 APS-C sensor'),
       ('SBIG', 'STF-8300M', 'CCD', '3326x2504', '5.4μm', 'TEC Cooled', 'USB 2.0', '800g', '$3,995',
        'Monochrome CCD camera for deep sky imaging'),
       ('Atik', '460EX', 'CCD', '2750x2200', '4.54μm', 'TEC Cooled', 'USB 2.0', '850g', '$2,799',
        'Color CCD camera with excellent sensitivity');

-- Insert sample eyepiece data
INSERT INTO skyquest.eyepiece (brand, model, focal_length, apparent_fov, barrel_size, eye_relief, field_stop, weight,
                               price, description)
VALUES ('Tele Vue', 'Nagler 31mm', '31mm', '82°', '2"', '19mm', '42mm', '680g', '$595',
        'Ultra-wide field premium eyepiece'),
       ('Tele Vue', 'Ethos 21mm', '21mm', '100°', '2"', '15mm', '36mm', '815g', '$895', 'Extreme wide field eyepiece'),
       ('Explore Scientific', '24mm 68° Ar', '24mm', '68°', '2"', '16mm', '28.5mm', '520g', '$299',
        'Wide field eyepiece with argon gas'),
       ('Baader', 'Morpheus 17.5mm', '17.5mm', '76°', '2"', '17mm', '23mm', '360g', '$359',
        'Wide field eyepiece with excellent eye relief'),
       ('Celestron', 'X-Cel LX 25mm', '25mm', '55°', '1.25"', '20mm', '24mm', '180g', '$89',
        'Good value eyepiece with long eye relief');

-- Insert sample filter data
INSERT INTO skyquest.filter (brand, model, filter_type, thread_size, wavelength, transmission, optical_density,
                             application, weight, price, description)
VALUES ('Baader', 'UHC-S', 'Narrowband', '2"', '486nm, 656nm', '90%', NULL, 'Deep Sky', '45g', '$199',
        'Ultra High Contrast filter for nebulae'),
       ('Astronomik', 'OIII 12nm', 'Narrowband', '2"', '500.7nm', '12nm FWHM', NULL, 'Deep Sky', '40g', '$289',
        'Oxygen III narrowband filter'),
       ('Chroma', 'H-alpha 3nm', 'Narrowband', '2"', '656.3nm', '3nm FWHM', NULL, 'Deep Sky', '50g', '$449',
        'Hydrogen-alpha ultra narrowband filter'),
       ('ZWO', 'L-Pro', 'Light Pollution', '2"', '400-700nm', '90%', NULL, 'Deep Sky', '35g', '$129',
        'Light pollution suppression filter'),
       ('Optolong', 'UV/IR Cut', 'Broadband', '2"', '400-700nm', '95%', NULL, 'Deep Sky', '30g', '$79',
        'UV and IR blocking filter for color cameras'),
       ('Baader', 'Solar Continuum', 'Solar', '2"', '540nm', '1%', 'ND 2.0', 'Solar', '40g', '$159',
        'Solar observation filter for white light'),
       ('Celestron', 'Moon & Skyglow', 'Light Pollution', '1.25"', '400-700nm', '85%', NULL, 'Lunar/Planetary', '25g',
        '$49', 'Light pollution and moon brightness filter');
